...
function HomePage() {
  ...
  //  آیا کاربر من می‌تواند کلیک کند؟
  ...
  const shuffleCards = () => {
    //  هر میوه را دو بار کپی کن چون میخوام 4*4 بشه (یک جفت)
  ...
  return (
    <div
      className="min-h-screen flex items-center bg-gradient-to-r from-blue-100 via-purple-200 to-pink-100 
                animate-gradient-x   "
    >
      <div className="max-w-3xl p-6 flex flex-col rounded-2xl justify-center items-center mx-auto bg-gradient-to-r from-pink-200 to-purple-500">
        {/* صفحه بازی */}
        ...
        <div className="mt-3 opacity-60 font-bold  p-2 ">
          <p>
            کارت‌های جفت شده: {matched.length / 2} از {items.length}
          </p>
          ...
          {matched.length === 16 && (
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
              <div className="bg-white rounded-xl shadow-lg p-8 text-center max-w-lg w-full mx-4">
                ...
                <button
                  ...
                  className="px-8 py-3 bg-blue-500 text-white rounded-lg hover:bg-blue-600 
                     transition duration-200 font-medium text-lg w-48"
                >
                  بازی جدید
                </button>
              </div>
